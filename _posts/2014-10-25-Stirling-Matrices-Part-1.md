...
Initially, the interest was in being able to determine the coefficients of such polynomials for the finite \\(k\\)th order prime polynomials. However, the following construction leads to considerations of so called Stirling matrices. 
